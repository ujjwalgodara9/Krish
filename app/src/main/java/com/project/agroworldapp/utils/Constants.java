...
public class Constants {
    ...
    public static final String ABOUT_US_PAGE = "https://www.youtube.com/watch?v=dQw4w9WgXcQ";
    public static final String PRIVACY_POLICY = "https://www.youtube.com/watch?v=dQw4w9WgXcQ";
